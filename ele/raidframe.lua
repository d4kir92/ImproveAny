	...
	if ImproveAny:GetWoWBuild() ~= "RETAIL" then
		...
		function ImproveAny:RFModifySetSize(frame)
			...
			if InCombatLockdown() then
				...
				hooksecurefunc(frame, "SetSize", function(sel, sw1, sh1)
		...
		function ImproveAny:RFAddBuffs(frame)
			...
			if frame.GetName and frame:GetName() and frame.setup == nil then
				...
				hooksecurefunc(_G[frame:GetName() .. "Buff" .. 1], "SetSize", function(sel, w, h)
				...
				hooksecurefunc(_G[frame:GetName() .. "Debuff" .. 1], "SetSize", function(sel, w, h)
