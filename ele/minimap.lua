...
function ImproveAny:UpdateMinimapSettings()
	if ImproveAny:IsEnabled("MINIMAP", false) and ImproveAny:IsEnabled("MINIMAPSHAPESQUARE", false) and not ImproveAny:IsAddOnLoaded("DragonflightUi") then
		ImproveAny:SHAPE("SQUARE")
	else
		ImproveAny:SHAPE("ROUND")
	end

	if ImproveAny:IsEnabled("MINIMAP", false) and ImproveAny:IsEnabled("MINIMAPHIDEBORDER", false) and not ImproveAny:IsAddOnLoaded("DragonflightUi") then
	...
	elseif not ImproveAny:IsAddOnLoaded("DragonflightUi") then
		if MinimapBorder then
			MinimapBorder:Show()
		end
