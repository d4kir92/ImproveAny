...
ImproveAny:RegisterEvent(frameXP, "CHAT_MSG_ADDON")
ImproveAny:OnEvent(
	frameXP,
	function(self, event, prefix, ...)
...
ImproveAny:RegisterEvent(frameXPInit, "GROUP_ROSTER_UPDATE")
ImproveAny:RegisterEvent(frameXPInit, "PLAYER_XP_UPDATE")
ImproveAny:RegisterEvent(frameXPInit, "PLAYER_ENTERING_WORLD")
ImproveAny:OnEvent(
	frameXPInit,
	function(self, event, ...)
				...
				for i = 1, 4 do
					...
					if PartyFrame then
						...
						function PartyFrameXPBar.think()
							...
							ImproveAny:After(1, PartyFrameXPBar.think, "PartyFrameXPBar.think")
						end
