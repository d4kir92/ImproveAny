...
ImproveAny:AddTrans("ruRU", "LID_BADGES", "Значки")
ImproveAny:AddTrans("ruRU", "LID_TOOLTIP", "Подсказка")
ImproveAny:AddTrans("ruRU", "LID_LOOKINGFORGROUP", "Поиск группы")
ImproveAny:AddTrans("ruRU", "LID_WIDGETS", "Виджеты")
ImproveAny:AddTrans("ruRU", "LID_CONSOLEVARIABLES", "Консольные переменные")
ImproveAny:AddTrans("ruRU", "LID_USERINTERFACE", "Интерфейс")
ImproveAny:AddTrans("ruRU", "LID_DURABILITYFRAME", "Прочность")
...
ImproveAny:AddTrans("ruRU", "LID_TOKENBARRESTORE", "Запоминать отслеживаемые валюты")
