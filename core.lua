		...
		ImproveAny:CreateMinimapButton(
			{
				...
				["var"] = mmbtn,
				["dbtab"] = IATAB,
				["vTT"] = {{"ImproveAny |T136033:16:16:0:0|t", "v|cff3FC7EB0.9.119"}, {ImproveAny:GT("LEFTCLICK"), ImproveAny:GT("MMBTNLEFT")}, {ImproveAny:GT("RIGHTCLICK"), ImproveAny:GT("MMBTNRIGHT")}},
				["funcL"] = function()
